...
# 
# images_dir is 'pet_images/'
# results_dict is {fileName : [pet label]} dictionary
...
def classify_images(images_dir, results_dic, model):
    ...
    for key in results_dic:
       ...
       # for debug
       # print('what is the classified model_label? {}'.format(model_label))
              
       # defines truth as pet image label (label List)
       ...
       # the extend function 
           ...
           print("classified label is not the same: pet image: {} classified image: {}".format(truth, model_label))
